...
VIDEO_SOURCE = "data/2.mp4"         # Путь к файлу, 0 для веб-камеры или RTSP-URL
...
CONFIDENCE_THRESHOLD = 0.25          # Порог детекции (низкий — для лучшего обнаружения детей/дальнего плана)
YOLO_IMGSZ = 1280                   # Разрешение inference (1280 = +72% детекций мелких/дальних людей)
POSE_SKIP_FRAMES = 1                # Child-детектор каждый кадр (свежий age-голос YOLO26)
...
AGE_MODEL_PATH = "models/age_classifier_v2.onnx"  # ML-модель: порог 12 лет, video augmentations
...
SHOW_DEBUG_SCORES = False           # Показывать debug-скоры (Y26/HB/P/M/Rh/Ah/AVG) под bbox для диагностики
